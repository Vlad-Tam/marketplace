<<<<<<<< HEAD:src/main/java/com/vladtam/jspapplication/models/Category.java
package com.vladtam.jspapplication.models;

import java.util.Objects;

public class Category implements BaseModelInterface {
    private Integer id;
    private String name;
...
>>>>>>>> main:task2/src/main/java/com/vladtam/marketplace/models/Category.java
