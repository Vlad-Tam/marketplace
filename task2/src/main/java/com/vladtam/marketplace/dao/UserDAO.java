<<<<<<<< HEAD:src/main/java/com/vladtam/jspapplication/daos/UserDAO.java
...
public class UserDAO implements BaseDAOInterface {
    ...
    private void addAdvertisement(ResultSet rs, Set<Advertisement> salesList) throws SQLException {
        ...
        if (advertisementId != 0) {
            salesList.add(new Advertisement(advertisementId, new BasicAdvertisementInfo(rs.getString("advertisement_name"), rs.getString("advertisement_description"), rs.getDouble("advertisement_price")), rs.getBoolean("advertisement_status")));
        }
    }
...
>>>>>>>> main:task2/src/main/java/com/vladtam/marketplace/dao/UserDAO.java
}